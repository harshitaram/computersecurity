...
if __name__ == "__main__":
    ...
    with open("step0-topsites.csv", "r") as input_file:
        ...
        with open("step3-topsites-selenium.csv", "a", newline='') as output_file:
            # Create a CSV writer
    ...
    driver.quit()
    #print(line_count)
    print("Selly TOP only HTTPS: " + str(count_a))
    print("Selly TOP both: " + str(count_b))
    print("Selly TOP only HTTP: " + str(count_c))
    print("Selly TOP Neither: " + str(count_d))  
